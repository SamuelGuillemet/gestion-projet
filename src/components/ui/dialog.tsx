...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex sm:flex-row flex-col-reverse sm:justify-end gap-2 bg-muted/50 -mx-4 -mb-4 p-4 border-t rounded-b-md",
        className,
      )}
      {...props}
    >
